      ...
      <div className='container container-lg'>
        <div className='row gy-5'>
          <div className='col-lg-8 pe-xl-4'>
              ...
              <div className='blog-item'>
                ...
                <div className='blog-item__content mt-24'>
                  ...
                  <p className='text-gray-700 pb-24 mb-24 border-bottom border-gray-100'>
                    Re-engagement — objectives. As developers, we rightfully
                    obsess about the customer experience, relentlessly working
                    to squeeze every millisecond out of the critical rendering
                    path, optimize input latency, and eliminate...
                  </p>
            ...
            <div className='mt-48'>
              <h6 className='mb-32'>
                The following are the four main market segments in which
                e-commerce is present. These are the following:
              </h6>
              <div className='row gy-4'>
              ...
              <div className='d-flex align-items-center flex-sm-nowrap flex-wrap gap-24 mb-16'>
                ...
                <div className='flex-grow-1'>
                  <h6 className='text-lg'>
                    <Link href='/blog-details' className='text-line-3'>
